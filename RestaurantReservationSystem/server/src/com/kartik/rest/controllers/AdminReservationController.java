...
public class AdminReservationController {
	...
	@PUT
	@Path("/updateReservation/{emailId}/{token}")
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	...
	public Reservation updateReservation(Reservation reservation, @PathParam("emailId") String emailId, @PathParam("token") String token) {
